...
class Verifier:
    ...
    def verify_claim(self, claim):
        ...
        system_prompt = """
        You are VeritasAI, a razor-sharp fact-checker. 
        Analyze the user's claim based strictly on the provided evidence. 
        If the evidence is empty, rely on your internal knowledge.
        
        Return ONLY valid JSON:
        {
          "verdict": "REAL", "FAKE", "MISLEADING", or "UNCLEAR",
          "confidence": a number from 0 to 100,
          "explanation": "2-3 direct sentences explaining the truth."
        }
        """
